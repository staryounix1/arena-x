...
function PublicNavbar() {
  ...
  const moreLinks = [...(showArenaEntry ? [{ href: '/arena', label: copy.arena, icon: Swords }] : []), { href: '/leaderboard', label: copy.leaderboard, icon: BarChart3 }, { href: '/momentum', label: copy.pulse, icon: Zap }, { href: '/live', label: copy.live, icon: Video }, ...(user ? [{ href: '/orders', label: 'طلباتي', icon: Package }] : []), { href: '/support', label: 'الدعم', icon: MessageCircle }, ...(user?.role === 'ADMIN' ? [{ href: '/admin', label: 'لوحة الإدارة', icon: ShieldCheck }] : [])];
  return <>
...
function Footer() { return <footer className="site-footer"><div className="shell footer-inner"><span><strong>eFootball ARENA</strong> منصة تنافسية احترافية</span><span><Link href="/terms" className="text-link">الشروط</Link> • <Link href="/privacy" className="text-link">الخصوصية</Link> • <Link href="/rules" className="text-link">النزاعات</Link> • <Link href="/support" className="text-link">الدعم</Link></span></div></footer>; }
function SiteMeta() {
  const [location] = useLocation();
  useEffect(() => {
...
function HomePage() {
  ...
  return <div className="ex">
    ...
    <section className="ex-trust">
      <div className="ex-trust-grid ex-hud">
...
function MatchesPage() {
  ...
  return <div className="ex">
    <section className="ex-section ex-shell ex-matches-section">
      ...
      <div className="ex-trust ex-matches-trust"><div className="ex-trust-grid ex-hud">
        <span className="ex-trust-item"><ShieldCheck className="h-5 w-5" /><span><strong>ضمان مالي</strong><small>الرهان محجوز حتى اعتماد النتيجة</small></span></span>
        <span className="ex-trust-item"><Users className="h-5 w-5" /><span><strong>مجتمع ينبض</strong><small>{shownOnline} لاعب متصل الآن</small></span></span>
        <span className="ex-trust-item"><MessageCircle className="h-5 w-5" /><span><strong>دعم بشري</strong><small>مرافقة عند الحاجة وحل النزاعات</small></span></span>
      </div></div>
