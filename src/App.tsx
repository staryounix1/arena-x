...
function Footer() { return <footer className="site-footer"><div className="shell footer-inner"><span><strong>eFootball ARENA</strong> منصة تنافسية احترافية</span></div></footer>; }
function SiteMeta() {
  const [location] = useLocation();
  useEffect(() => {
