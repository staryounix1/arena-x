...
4. Run `20260920_wallet_security_lockdown.sql` last. It removes direct wallet writes, protects verification fields, and makes the wallet ledger immutable.

Before applying the last migration, reconcile any negative balances and legacy open matches whose escrow status is not `HELD`.
