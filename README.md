...
من **SQL Editor** في Supabase، شغّل ملفات `supabase/migrations/` كلها بالترتيب الزمني. migration الأخيرة مهمة لحماية المحفظة:

- `20260920_wallet_security_lockdown.sql`

لا تشغّل migration الأخيرة قبل الملفات السابقة. قبل تطبيقها راجع أي رصيد سالب أو مباراة مفتوحة بدون `escrow_status = 'HELD'`، لأن الملف يضيف قيوداً تمنع إنشاء حالات مالية جديدة غير صحيحة.
